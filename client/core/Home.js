...
import llagaImg from './../assets/images/llagaImg.png'
          ...
          <Grid container spacing={8}>
            <Grid item xs={12}>
              <Card className={classes.card}>
                ...
                <CardMedia className={classes.media} image={llagaImg} title="Arrillaga Family Dining Commons"/>
                ...
                <CardContent>
                  <Typography type="body1" component="p">
                    Welcome to the Stanford Yums home page. 
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
